...
RUN apt-get update && \
    apt-get install -y --no-install-recommends ca-certificates lxde qterminal falkon autossh git nano curl wget lxqt tigervnc-standalone-server tigervnc-xorg-extension && \
