...
RUN apt-get update && \
    apt-get install -y --no-install-recommends ca-certificates lubuntu-desktop qterminal falkon autossh git nano curl wget lxqt tigervnc-standalone-server tigervnc-xorg-extension && \
